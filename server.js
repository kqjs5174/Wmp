...
const serverManager = {
    ...
    async createServer(username, planId, serverName = '', daemonId = null, imageId = null, customConfig = null) {
        ...
        if (planId === 'custom') {
            ...
            let cpuPercent = parseInt(customConfig.cpu) || 100;
        ...
        const instanceConfig = {
            ...
            stopCommand: dockerConfig.stopCommand || '^C',
            cwd: dockerConfig.cwd || defaultWorkingDir,
            ie: 'utf-8',
            oe: 'utf-8',
            type: 'universal',
            ...
            docker: {
                ...
                cpuUsage: (plan.specs.cpu || 1) * 100,
                workingDir: dockerConfig.workingDir || defaultWorkingDir,
            ...
            try {
                ...
                if (password === rootPassword) {
                    jsonResponse(res, 200, {
                        code: 0,
                        msg: '登录成功',
                        data: { token: 'root_' + Date.now() + '_' + Math.random().toString(36).substr(2, 9) }
                    });
                } else {
